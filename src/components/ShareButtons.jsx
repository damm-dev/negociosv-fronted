...
export default function ShareButtons({ url, title, description }) {
  ...
  const shareTitle = title || 'Mira este negocio en NegocioSV';
  const shareDescription = description || 'Descubre negocios locales en El Salvador';
  ...
  return (
    <div className="share-buttons-container">
      <h3 className="share-title">Compartir</h3>
